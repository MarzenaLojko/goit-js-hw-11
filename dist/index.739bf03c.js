...
var _imagesService = require("./images-service");
var _imagesServiceDefault = parcelHelpers.interopDefault(_imagesService);
const imageApiService = new (0, _imagesServiceDefault.default)();
...
function onSubmit(e) {
    ...
    if (imageApiService.query === "") {
        (0, _notiflixNotifyAio.Notify).info("Please enter your search query!");
        return;
    } else imageApiService.getImage().then((data)=>{
        let queriesArray = data.hits;
        if (queriesArray.length === 0) (0, _notiflixNotifyAio.Notify).failure("Sorry, there are no images matching your search query. Please try again.");
...
},{"notiflix/build/notiflix-notify-aio":"eXQLZ","./images-service":"1HCNU","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eXQLZ":[function(require,module,exports) {
var global = arguments[3];
/*
...
},{}],"1HCNU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class ImagesApiService {
    ...
    async getImage() {
        const response = await (0, _axiosDefault.default).get(`${BASE_URL}?key=${API_KEY}&q=${this.searchQuery}&${searchParams}&page=${this.page}`);
        this.page += 1;
